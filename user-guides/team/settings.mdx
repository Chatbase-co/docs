...
![Team Settings General](images/settings/team-settings-general.png)

# Members

This tab displays all the information about your team members, as well as those you've invited but haven't responded yet.

![Team Settings Members](images/settings/team-settings-members.png)
...
![Team Settings Members Limit](images/settings/team-settings-members-limit.png)
...
![Team Settings Members Change Role](images/settings/team-settings-members-change-role.gif)

### Remove team member

To remove a member from the team

![Team Settings Members Remove Member](images/settings/team-settings-members-remove-member.gif)
...
![Team Settings Revoke Resend Invite](images/settings/team-settings-revoke-resend-invite.png)
...
![Team Settings Plans](images/settings/team-settings-plans.png)
...
![Team Settings Plans Addon](images/settings/team-settings-plans-addon.gif)
...
![Team Settings Plans Addon Quantity](images/settings/team-settings-plans-addon-quantity.gif)
...
![Team Settings Billing Subscription Details](images/settings/team-settings-billing-subscription-details.png)
...
![Team Settings Billing Usage](images/settings/team-settings-billing-usage.png)
...
![Team Settings Billing Details](images/settings/team-settings-billing-details.png)

### Billing Email

This section shows the email address that will receive automated copies of all invoices for this team.

![Team Settings Billing Email](images/settings/team-settings-billing-email.png)

### Tax ID

In this section, you can add a tax ID to be displayed on the invoice if needed.

![Team Settings Billing Tax](images/settings/team-settings-billing-tax.png)
...
![Team Settings Billing Method](images/settings/team-settings-billing-method.png)
...
![Team Settings Billing History](images/settings/team-settings-billing-history.png)
...
![Team Settings API Keys](images/settings/team-settings-api-keys.gif)

# OpenAI Key

You can add an external OpenAI API Key here. It will be used when your monthly message credits run out.

![Team Settings OpenAI Key](images/settings/team-settings-openai-key.png)