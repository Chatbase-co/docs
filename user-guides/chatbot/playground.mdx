...
<img 
  src="images/playground/playground-settings.png" 
...
<img 
  src="images/playground/playground-compare.png" 
  alt="Playground Compare" 
  width="600"
  style={{ margin: 'auto' }} 
/>
...
<img 
  src="images/playground/playground-compare-sync.png" 
  alt="Playground Compare Sync" 
  width="600"
  style={{ margin: 'auto' }} 
/>
...
<img 
  src="images/playground/playground-compare-actions.png" 
  alt="Playground Compare Actions" 
  width="600"
  style={{ margin: 'auto' }} 
/>
...
<img 
  src="images/playground/playground-demo.gif" 
  alt="Playground Demo" 
  width="600"
  style={{ margin: 'auto' }} 
/>